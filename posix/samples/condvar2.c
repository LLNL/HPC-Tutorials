...
* FILE: condvar2.c
* DESCRIPTION:
*   This example has a BUG! It is a variation on the condvar1.c example. 
...
*   program. The solution program is condvar2_sol.c.
...
int main(int argc, char *argv[])
{
  ...
  */
  ...
  pthread_create(&threads[5], &attr, watch_count, (void *)&thread_ids[5]);
